...
echo "Generating incident response report...standby..."
...
retVal=$?
if [ $retVal -ne 0 ]; then
    ./tools/echo "LiME: Error in make, please check dependancies"
    ./tools/echo "    : make sure you have linux headers installed"
    ./tools/cat make_log
    exit $retVal
else
